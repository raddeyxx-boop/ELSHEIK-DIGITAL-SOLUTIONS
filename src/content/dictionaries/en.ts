...
export const en: Dictionary = {
  ...
  nav: { home: "Home", services: "Services", work: "Work", about: "About", process: "Process", insights: "Insights", contact: "Contact", start: "Start a project", menu: "Open menu", close: "Close menu" },
