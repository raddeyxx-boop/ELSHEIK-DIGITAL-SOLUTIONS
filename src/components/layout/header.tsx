...
// Only the labels the header renders cross to the client: passing the whole
// dictionary would serialize every page's copy into every page's payload.
export type HeaderLabels = Pick<Dictionary, "nav" | "localeName">;
